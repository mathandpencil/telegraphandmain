...
qq.FileUploader = function(o){
	...
	if(o.button_name != undefined){
		//var button_name = '<div class="qq-upload-button tooltip">' + o.button_name + '</div>';
		var button_name = '<div class="qq-upload-button button Submit">' + o.button_name + '</div>';
	}
	else{
		var button_name = '<div class="qq-upload-button icons tooltip">+</div>'
	}
    ...
    qq.extend(this._options, {
      ...
      template: '<div class="qq-uploader">' + 
        ...
        fileTemplate: '<li>' +
                ...
                '<a id="qq-delete-file" style="display:none" href="#">Delete</a>' +
